...
## Suggested Service Tags (SUGGESTED — needs your confirmation)
...
| Project | Status | Images | Tags / Type | Issues |
| --- | --- | --- | --- | --- |
| AKU World | published | 26 | NFT Miami Experiential Event, Immersive Environment, immersive-environment, experiential-event, nft-miami | — |
| BuzzFeed NewFronts | published | 18 | Event Production, Multimedia Design, Stage Design, Lighting Design, event-production, multimedia-design, stage-design, lighting-design | — |
| CNN: Road to 270 | published | 6 | Projection Mapping, Interactive, projection-mapping, interactive, case-study | — |
| Create Our Future | published | 10 | Experiential Event, Stage Design, Concert, VR Experience, Lighting Design, stage-design, concert, experiential-event, vr-experience, lighting-design | — |
| Destination | published | 21 | Interactive Art Canvas, Custom Scenic, Fabrication, Stage Design, Concert, Event Production, interactive-art-canvas, custom-scenic, fabrication, experiential-event | — |
| Disenchantment | published | 12 | COMIC-CON Exhibition, comic-con-exhibition, case-study | — |
| DUBAI 360: Spherical Projection Theatre | published | 42 | Projection Mapping, Content, Deployment, Software, projection-mapping, content, deployment, software | — |
| El Camino | published | 11 | COMIC-CON Exhibition, comic-con-exhibition, case-study | — |
| FLIR Interactive History Wall | published | 1 | Interactive Media Display, Permanent Installation, interactive-media-display, permanent-installation, ai-computer-vision | — |
| G-MAN Experiential Campaign | published | 12 | Experiential Event, experiential-event, case-study | — |
| Infinite Playlist Tour | published | 30 | Interactive Media Experience, Event Production, Festival Activation, interactive-media-experience, event-production, festival-activation | — |
| MyShelter | published | 27 | Experiential Event, Immersive Environment, Product Launch, Retail Build, environmental-design, immersive-experience, product-launch, retail-build | — |
| PROJECTING CHANGE: Racing Extinction | published | 11 | Projection Mapping, Content, Deployment, Software, projection-mapping, content, deployment, software | — |
| Projekt X | published | 21 | Custom Fabricated Stage Element, Specialized Production, custom-scenic, fabrication, stage-design, concert | — |
| Run for the Oceans | published | 6 | Interactive Media Experience, Event Production, Marathon Activation, Infinity Mirror, interactive-media-experience, event-production, marathon-activation | — |
| Super Bowl 2020 | published | 1 | Super Bowl 2020 Experiential Event, Projection Mapping, Interactive AR, projection-mapping, interactive-ar, experiential-event, super-bowl-2020 | — |
| The Great Escape | published | 14 | Product Launch Experience, product-launch-experience, case-study | — |

## Image URLs Shared Between Projects

None — every project image is used by a single project.

## Service Hero Image Duplicates

### `/images/verified/work/super-bowl-2020/IMG_1686_Moment-21565bd4.jpg` — shared by 4 services

- **3D Animation & Motion Capture** (/services/3d-animation-motion-capture)
  - candidate: `/images/verified/work/super-bowl-2020/IMG_1686_Moment-21565bd4.jpg` (from project super-bowl-2020)
  - candidate: `/images/deck/disenchantment/01-image80.jpg` (from project disenchantment)
  - candidate: `/images/deck/disenchantment/02-image82.jpg` (from project disenchantment)
- **Labor Hire & Crew Roles (TD, PM, A1/A2, V1/V2, L1/L2)** (/services/labor-hire-crew-roles)
  - candidate: `/images/verified/work/super-bowl-2020/IMG_1686_Moment-21565bd4.jpg` (from project super-bowl-2020)
...
- **Materials Sourcing & Selection** (/services/materials-sourcing-selection)
  - candidate: `/images/verified/work/super-bowl-2020/IMG_1686_Moment-21565bd4.jpg` (from project super-bowl-2020)
  - candidate: `/images/deck/create-our-future/01-image70.png` (from project create-our-future)
  - candidate: `/images/deck/create-our-future/02-image72.png` (from project create-our-future)
- **Software Development** (/services/software-development)
  - candidate: `/images/deck/g-man-experiential-campaign/01-image264.png` (from project g-man-experiential-campaign)
...
- **CNC Machining** (/services/cnc-machining)
  - candidate: `/images/deck/el-camino/01-image134.jpg` (from project el-camino)
  - candidate: `/images/deck/el-camino/02-image115.jpg` (from project el-camino)
  - candidate: `/images/deck/el-camino/03-image116.jpg` (from project el-camino)
- **Consultation & System Design** (/services/consultation-system-design)
  - candidate: `/images/verified/work/flir/DC+History+Wall+Demo+4_Moment1-0e89b875.jpg` (from project flir)
  - candidate: `/images/deck/el-camino/01-image134.jpg` (from project el-camino)
  - candidate: `/images/deck/el-camino/02-image115.jpg` (from project el-camino)
- **System Maintenance & Support** (/services/system-maintenance-support)
  - candidate: `/images/deck/destination/01-image77.png` (from project destination)
  - candidate: `/images/deck/destination/02-image86.png` (from project destination)
  - candidate: `/images/deck/destination/03-image111.jpg` (from project destination)

### `/images/verified/work/dubai-360-spherical-projection-theatre/dubai_360_spherical_projection_theatre_preview.png` — shared by 3 services

- **Media Server & Playback Solutions** (/services/media-server-playback-solutions)
...
- **Permanent Installation** (/services/permanent-installation)
  - candidate: `/images/deck/destination/01-image77.png` (from project destination)
  - candidate: `/images/deck/destination/02-image86.png` (from project destination)
  - candidate: `/images/deck/destination/03-image111.jpg` (from project destination)
- **Pre-Visualization** (/services/pre-visualization)
  - candidate: `/images/deck/dubai-360-spherical-projection-theatre/02-image246.jpg` (from project dubai-360-spherical-projection-theatre)
  - candidate: `/images/deck/dubai-360-spherical-projection-theatre/03-image311.jpg` (from project dubai-360-spherical-projection-theatre)
  - candidate: `/images/deck/dubai-360-spherical-projection-theatre/04-image240.jpg` (from project dubai-360-spherical-projection-theatre)
...
- **Engineering Certification** (/services/engineering-certification)
  - candidate: `/images/deck/aku-world/01-image27.jpg` (from project aku-world)
  - candidate: `/images/deck/aku-world/02-image20.jpg` (from project aku-world)
  - candidate: `/images/deck/aku-world/03-image15.jpg` (from project aku-world)
- **Event Planning & Logistics** (/services/event-planning-logistics)
  - candidate: `/images/deck/aku-world/01-image27.jpg` (from project aku-world)
  - candidate: `/images/deck/aku-world/02-image20.jpg` (from project aku-world)
  - candidate: `/images/deck/aku-world/03-image15.jpg` (from project aku-world)

### `/images/portfolio/aku-world/Concert-WideAngle.jpg` — shared by 2 services

- **Lighting Design** (/services/lighting-design)
  - candidate: `/images/portfolio/run-for-the-oceans/KMP_2618.jpg` (from project run-for-the-oceans)
  - candidate: `/images/portfolio/run-for-the-oceans/KMP_2820.jpg` (from project run-for-the-oceans)
  - candidate: `/images/portfolio/run-for-the-oceans/KMP_3614.jpg` (from project run-for-the-oceans)
- **Staging & Rigging** (/services/staging-rigging)
  - candidate: `/images/deck/aku-world/01-image27.jpg` (from project aku-world)
  - candidate: `/images/deck/aku-world/02-image20.jpg` (from project aku-world)
  - candidate: `/images/deck/aku-world/03-image15.jpg` (from project aku-world)

### `/images/portfolio/myshelter/Middle.jpg` — shared by 2 services

- **Production Management** (/services/production-management)
  - candidate: `/images/deck/cnn-road-to-270/01-image250.jpg` (from project cnn-road-to-270)
  - candidate: `/images/deck/cnn-road-to-270/02-image235.jpg` (from project cnn-road-to-270)
  - candidate: `/images/deck/cnn-road-to-270/03-image239.jpg` (from project cnn-road-to-270)
- **Set & Scenic Assembly** (/services/set-scenic-assembly)
  - candidate: `/images/deck/myshelter/01-image51.jpg` (from project myshelter)
  - candidate: `/images/deck/myshelter/02-image67.jpg` (from project myshelter)
  - candidate: `/images/deck/myshelter/03-image61.jpg` (from project myshelter)
...
## Broken Related Work Links (service → project)

None — every relatedWork entry resolves to a project.

## Projects With Zero Images

None.

## Capability Tiles (default grid)
