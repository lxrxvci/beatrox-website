  ...
  return (
    <section className="section border-t border-white/10">
      <div className="max-w-[1400px] mx-auto">
        <h2 className="heading-sm text-white mb-8">{title}</h2>
                ...
                {file ? (
                  ...
                  <div className="corner-ticks border border-white/10 bg-black/70 backdrop-blur-sm">
                        ...
                        {video.embedUrl ? (
                          ...
                          <div className="h-full w-full flex items-center justify-center text-center px-6">
                            <a
                              ...
                              className="text-sm uppercase tracking-[0.16em] text-white hover:text-white transition-colors"
                            >
                              Open video source
                            </a>
                          </div>
                    ...
                    <div className="p-5 sm:p-6">
                      ...
                      <p className="mono text-white">{video.provider.toUpperCase()}</p>
                    </div>
                  </div>
                )}
              </article>
